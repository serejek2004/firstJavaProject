...
class DeliveryDroneTest {
    ...
    void testGetMaxFlyingDistanceAtCurrentSpeedForDeliveryDrone() {
        ...
        String expected = "DeliveryDrone - currentSpeed=20.0, currentAltitude=600.0 currentBattaryLevel=2500.0," +
                " battaryCapacity=5000.0, consumptionBattary=250.0, currentMaxFlyingDistance=1000.0";
    ...
    void testToStringForDeliveryDrone() {
        DeliveryDrone firstDrone = new DeliveryDrone(2500, 5000, 250, 20, 600);
        String expected = "DeliveryDrone - currentSpeed=20.0, currentAltitude=600.0 currentBattaryLevel=2500.0," +
                " battaryCapacity=5000.0, consumptionBattary=250.0, currentMaxFlyingDistance=0.0";
        String actual = firstDrone.toString();
        Assertions.assertEquals(expected, actual);
    }
}